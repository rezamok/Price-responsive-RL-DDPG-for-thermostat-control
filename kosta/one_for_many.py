...
def predict_agent(env,network2,ddpg_agent,test_dir, obs_path=None):
    # Read data
    observations = load_data('Data',obs_path)
    ...
    for episode in range(num_episodes):  
        ...
        if episode < num_episodes:
            observations_n.iloc[episode+1, 2] = s_curr[2]
    ...
    # plot_improvements(stats,stats_rb,comfort_violations,comfort_violations_rb,test_dir)
    # plot_hist_comf_viols(comfort_violations,test_dir)
    return actions, temperatures, Price
