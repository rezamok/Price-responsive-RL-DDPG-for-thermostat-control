...
MODEL_SAVE_PATH = r'C:\Users\remok\OneDrive - Danmarks Tekniske Universitet\Skrivebord\RL TRV\Models\pcnnNew - complete\pcnnNew - complete\saves\models'
...
def parameters(unit: str = 'DFAB', to_normalize: bool = True,
