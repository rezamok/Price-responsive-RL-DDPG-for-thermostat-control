...
def build_physics_based_inputs_outputs_indices():
    """
    Function to create the inputs, outputs, base and effect indices for physics-based model.
    This makes the black-box models compliant with it.
    """
    room1 = "274"
    if room1 == '274':
   ...
   # all_outputs = ['Room temperature', 'Power room']

    base_indices = [0, 1, 2, 3, 5, 6, 7, 8, 9]
    effect_indices = [3, 4, 10, 11]

    return all_inputs, all_outputs, base_indices, effect_indices