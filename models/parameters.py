...
import os
import sys
# os.chdir(r'C:\Users\momi\PycharmProjects\tl_drl_Mina\RL\DRL\models')
os.chdir(r'C:\Users\remok\OneDrive - Danmarks Tekniske Universitet\Skrivebord\RL TRV\Models\efficient-drl-main\saves\Models')

# DATA_SAVE_PATH = os.path.join("..", "efficient-drl1","saves", "data")
# FIGURE_SAVE_PATH = os.path.join("..", "efficient-drl1", "saves", "figures")
# MODEL_SAVE_PATH = os.path.join("..", "efficient-drl1", "saves", "models")
print("ggg")
print(os.getcwd())
...
DATA_SAVE_PATH = r'C:\Users\remok\OneDrive - Danmarks Tekniske Universitet\Skrivebord\RL TRV\Models\pcnnNew - complete\pcnnNew - complete\saves\Data'
FIGURE_SAVE_PATH = r'C:\Users\remok\OneDrive - Danmarks Tekniske Universitet\Skrivebord\RL TRV\Models\pcnnNew - complete\pcnnNew - complete\saves\figures'
MODEL_SAVE_PATH = r'C:/Users/remok/OneDrive - Danmarks Tekniske Universitet/Skrivebord/RL TRV/Models/Price-Responsive RL/saves/Models'
...
def parameters(unit: str = 'UMAR', to_normalize: bool = True,
                ...
                overlapping_distance: int = 4, validation_percentage: float = 0.2, test_percentage: float = 0.0,
