"""
Modification of the A2C algorithm to allow pretraining on recurrent policies
According to PR #315
...
from agents.base_class import ActorCriticRLModel
from stable_baselines.common import explained_variance, tf_util, SetVerbosity, TensorboardWriter #,ActorCriticRLModel
