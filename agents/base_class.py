"""
Modification of the base classes to allow pretraining on recurrent policies
According to PR #315
https://github.com/hill-a/stable-baselines/pull/315/files
"""
...
from stable_baselines.common.callbacks import ConvertCallback
from agents.callbacks import BaseCallback, CallbackList
...
class OffPolicyRLModel(BaseRLModel):
    ...
    def is_using_her(self) -> bool:
        ...
        from agents.helpers import HindsightExperienceReplayWrapper
