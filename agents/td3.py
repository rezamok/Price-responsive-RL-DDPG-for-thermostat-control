...
from agents.base_class import OffPolicyRLModel
...
class TD3(OffPolicyRLModel):
    ...
    def learn(self, total_timesteps, callback=None,
        ...
        ############## MODIFICATION #################
        if (replay_wrapper is not None) & (not isinstance(self.replay_buffer, HindsightExperienceReplayWrapper)):
    ...
    def predict(self, observation, state=None, mask=None, deterministic=True):
        ...
        if isinstance(self.env, HERGoalEnvWrapper):
            ...
            if isinstance(observation, OrderedDict):
                observation = np.append(observation['observation'],
