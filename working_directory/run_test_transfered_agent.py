...
from kosta.checkpoint_utils import Alg1Logger,plot_test_data,Alg2Logger
from kosta.model_utils import get_network2, get_ddpg_agent_and_rb

NUM_EPISODES = 50 # We will test agent for this number of episodes
...
if __name__ == '__main__':
    ...
    logger1 = Alg1Logger(hp.checkpoint_dir,False)
    logger2 = Alg2Logger(os.path.join(hp.checkpoint_dir,f'room_{hp.rooms[0]}'), False)
#==============================================================================
# Test NON-RANDOM agent
    test_dir = os.path.join(logger1.save_dir,f'tests_not_random_agent_transfered_room_{hp.rooms[0]}')
    print('NON-RANDOM agent!')
    # load weights
    _,ddpg_agent.q_function,ddpg_agent.policy,_,_,_ = logger1.load_weights(
        EPISODE_CHECKPOINT,
        network2=None,
...
#==============================================================================
    ...
    test_dir = os.path.join(logger1.save_dir,f'tests_rb_agent_transfered_room_{hp.rooms[0]}')
